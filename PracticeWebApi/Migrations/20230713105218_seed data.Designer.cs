...
namespace PracticeWebApi.Migrations
{
    ...
    [Migration("20230713105218_seed data")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PracticeWebApi.Model.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PracticeWebApi.Model.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PracticeWebApi.Model.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PracticeWebApi.Model.Domain.Walk", b =>
                {
                    b.HasOne("PracticeWebApi.Model.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PracticeWebApi.Model.Domain.Region", "Region")
                        .WithMany()
